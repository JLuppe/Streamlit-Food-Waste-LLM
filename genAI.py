...
4. Cite specific chunks from the [CONTEXT] section in your answer that are indicated by "CHUNK ID # X:" where X is the chunk number that contains the supporting information. For example, if chunk 2 contains relevant information, include "CHUNK ID # 2:" in your response. If there are no relevant chunks, do not cite any.
